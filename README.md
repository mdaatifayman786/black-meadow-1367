...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/black-meadow-1367)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/black-meadow-1367
```

A live public deployment of this template is available at [https://black-meadow-1367.templates.workers.dev](https://black-meadow-1367.templates.workers.dev)
